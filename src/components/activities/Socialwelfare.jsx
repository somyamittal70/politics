...
export default function SocialWelfare() {
  ...
  return (
    <section id="social-welfare" className="relative bg-[#FDFAF5] overflow-hidden py-20 md:py-28">

      {/* Subtle line texture */}
      <div className="pointer-events-none absolute inset-0 opacity-[0.025]"
        style={{ backgroundImage: "linear-gradient(#0D1B3E 1px,transparent 1px)", backgroundSize: "100% 40px" }} />
      ...
      <div className="relative z-10 max-w-[1280px] mx-auto px-5 md:px-10 lg:px-16">
        ...
        <div ref={headerRef} className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20 items-end mb-14 md:mb-16">
          <div>
            ...
            <motion.h2 variants={fadeUp(0.08)} initial="hidden" animate={headerInView ? "show" : "hidden"}
              ...
              style={{ fontFamily: "'Playfair Display', serif" }}>
              Social<br /><em className="text-[#E8541A] not-italic italic">Welfare</em>
            </motion.h2>
          </div>
          <div>
        ...
        {/* ── IMPACT NUMBERS ── */}
        <div ref={statsRef} className="grid grid-cols-2 lg:grid-cols-4 gap-0 border border-[#EDE5D0] mb-16 md:mb-20">
            ...
            return (
              <motion.div
                ...
                className={`group relative flex flex-col gap-2 p-6 md:p-8
                  bg-[#F7F2E8] hover:bg-white transition-colors duration-300 overflow-hidden
                  ${i < 3 ? "border-r border-[#EDE5D0]" : ""}
                  ${i < 2 ? "border-b border-[#EDE5D0] lg:border-b-0" : ""}`}
              >
                <Icon size={20} className="text-[#138808] mb-1" strokeWidth={1.5} />
                <span className="text-[2.8rem] md:text-[3.2rem] font-black text-[#0D1B3E] leading-none"
                  style={{ fontFamily: "'Playfair Display', serif" }}>
                  <Counter target={s.num} suffix={s.suffix} inView={statsInView} />
                </span>
                <span className="text-[0.6rem] font-bold tracking-[0.18em] uppercase text-[#3D3526]/45"
          ...
          {initiatives.map((item, i) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -4 }}
                className="group relative bg-[#F7F2E8] border border-[#EDE5D0] p-6 overflow-hidden
                  hover:border-[#E8541A]/25 hover:shadow-[0_10px_32px_rgba(0,0,0,0.07)]
              ...
              >
                ...
                <div className="absolute top-4 right-4">
                  <span className="text-[0.55rem] font-black tracking-[0.15em] uppercase
                    text-[#0D1B3E]/20 border border-[#0D1B3E]/10 px-2 py-[3px]"
                    style={{ fontFamily: "Raleway, sans-serif" }}>{item.year}</span>
                </div>

                {/* Icon + index */}
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-11 h-11 flex items-center justify-center border border-[#EDE5D0] bg-white"
                    style={{ color: item.color }}>
                    <Icon size={20} strokeWidth={1.5} />
                  </div>
                  <span className="text-[0.6rem] font-black tracking-[0.2em] text-[#0D1B3E]/20"
                ...
                {/* Title */}
                <h4 className="text-[1.08rem] font-black text-[#0D1B3E] leading-snug mb-2"
                ...
                <div className="inline-flex items-center gap-1 mb-3 px-2 py-[3px] border"
                  ...
                  <span className="text-[0.7rem] font-bold text-[#0D1B3E]"
                    style={{ fontFamily: "'Playfair Display', serif" }}>{item.impact}</span>
                </div>

                {/* Desc */}
                <p className="text-[0.88rem] text-[#3D3526]/60 leading-[1.8] italic"
