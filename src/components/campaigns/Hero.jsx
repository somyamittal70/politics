...
function StatItem({ stat, index, animate }) {
  ...
  return (
    ...
    >
      ...
      <span
        className="text-[0.45rem] sm:text-[0.52rem] md:text-[0.58rem] font-black tracking-[0.15em] sm:tracking-[0.18em] md:tracking-[0.2em] uppercase text-white/40
    ...
    >
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-center w-full px-4 sm:px-6 md:px-12 lg:px-20 pt-16 sm:pt-20 md:pt-28 pb-0">
        <div className="max-w-[1280px] mx-auto w-full">
          ...
          >
            <span className="w-5 sm:w-8 h-[2px] bg-[#E8541A] rounded" />
            <span
              className="text-[0.55rem] sm:text-[0.63rem] font-black tracking-[0.25em] sm:tracking-[0.32em] uppercase text-[#E8541A]"
              style={{ fontFamily: "Raleway, sans-serif" }}
            >
              Campaigns & Movements
            </span>
          ...
          <motion.h1
            ...
            className="text-[2.5rem] sm:text-[3.5rem] md:text-[5rem] lg:text-[7rem] xl:text-[8rem]
              font-black leading-[0.87] text-white mb-3 sm:mb-5"
            style={{ fontFamily: "'Playfair Display', serif" }}
          >
            Campaigns
          </motion.h1>
          ...
          >
            ...
            <span
              className="text-[0.55rem] sm:text-[0.67rem] font-black tracking-[0.22em] sm:tracking-[0.28em] uppercase text-white/42"
              style={{ fontFamily: "Raleway, sans-serif" }}
            >
          ...
          <motion.p
            ...
            initial="hidden"
            animate={inView ? "show" : "hidden"}
            className="text-[0.85rem] sm:text-[1.05rem] md:text-[1.18rem] italic text-white/52 leading-[1.6] sm:leading-[1.88] max-w-2xl mb-6 sm:mb-10"
            style={{ fontFamily: "'Cormorant Garamond', serif" }}
          >
              ...
              >
                {activeTab === tab ? (
                  <>
                    ...
                    <span className="absolute inset-0 bg-[#E8541A]" />
                  </>
                ) : (
                  <>
                    <span className="relative z-10 text-white/48 hover:text-white/78">
                      {tab}
                    </span>
