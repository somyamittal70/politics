...
export default function AchievementsSection() {
  ...
  return (
    <section id="achievements" className="relative bg-[#0D1B3E] overflow-hidden py-20 md:py-28">
      ...
      <div className="relative z-10 max-w-[1280px] mx-auto px-5 md:px-10 lg:px-16">
        ...
        >
          ...
          <h2 className="text-[2.2rem] md:text-[3rem] lg:text-[3.5rem] font-black text-[#FDFAF5] leading-[1.1]"
            style={{ fontFamily: "'Playfair Display', serif" }}>
            Milestones & <em className="text-[#E8541A] not-italic italic">Achievements</em>
          </h2>
          <p className="text-[1rem] text-[#FDFAF5]/40 mt-3 max-w-lg mx-auto leading-relaxed italic"
            ...
            return (
              <motion.div
                ...
                className="group relative flex flex-col items-center justify-center gap-2
                  border border-[#FDFAF5]/[0.08] bg-[#162547]/60 py-8 px-4 overflow-hidden
                  hover:border-[#E8541A]/40 transition-all duration-300 hover:-translate-y-1"
              >
                {/* Hover glow */}
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                  style={{ background: "radial-gradient(circle at 50% 50%, rgba(232,84,26,0.06), transparent 70%)" }} />

                <Icon size={28} className="text-[#FDFAF5]/50" strokeWidth={1.5} />

                <span className="text-[2.6rem] md:text-[3rem] font-black text-[#E8541A] leading-none"
                  style={{ fontFamily: "'Playfair Display', serif" }}>
                  <Counter target={s.num} suffix={s.suffix} inView={statsInView} />
                </span>
                <span className="text-[0.62rem] font-bold tracking-[0.18em] uppercase text-[#FDFAF5]/35 text-center"
          ...
          {achievements.map((a, i) => {
            ...
            return (
              <motion.div
                ...
                className="group relative flex flex-col gap-4 bg-[#162547]/70 border border-[#FDFAF5]/[0.07]
                  p-6 overflow-hidden hover:border-[#E8541A]/30
              ...
              >
                ...
                <div className="absolute top-4 right-4">
                  <span className="text-[0.58rem] font-black tracking-[0.18em] uppercase
                    text-[#FDFAF5]/25 border border-[#FDFAF5]/10 px-2 py-[3px]"
                    style={{ fontFamily: "Raleway, sans-serif" }}>{a.year}</span>
                </div>

                {/* Icon */}
                <div className="w-12 h-12 flex items-center justify-center
                  bg-[#0D1B3E] border border-[#FDFAF5]/[0.08] rounded-sm"
                  style={{ color: a.color }}>
                ...
                {/* Title */}
                <h3 className="text-[1.15rem] font-black text-[#FDFAF5] leading-snug"
                  style={{ fontFamily: "'Playfair Display', serif" }}>{a.title}</h3>

                {/* Desc */}
                <p className="text-[0.88rem] text-[#FDFAF5]/45 leading-[1.8] flex-1 italic"
                ...
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity duration-400"
                  style={{ background: "radial-gradient(circle at 30% 50%,rgba(232,84,26,0.04),transparent 70%)" }} />
              </motion.div>
            );
          })}
        </div>
